    ...
    <>
      <div className="p-6">
        ...
        <div className="flex justify-center ">
          <p className="my-4 mx-2 sm:mx-20 lg:mx-36 px-4 py-2 text-sm sm:text-lg lg:text-xl  border-2 border-slate-700 text-gray-200 bg-sky-800 rounded-sm">
            ...
            mouse (Left and Right Click). New renders and updates always coming!
          </p>
        </div>
      </div>
      <DemoPage />
